# Monarch Package Repository

Build system for the Monarch Package Repository. This repo is a fork of [Omarchy Package repository](https://github.com/omacom-io/omarchy-pkgs/)
